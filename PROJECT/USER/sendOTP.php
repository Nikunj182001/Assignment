    ...
    <body>
                    ...
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <ul class="nav">
                                ...
                                <a href="cart"><i class="fa badge fa-shopping-cart px-3" style="font-size:20px" value="">
                                    </i></a>
                            </ul>
        ...
        <div class="hi">
            ...
            <form method="post">
                ...
                <input type="text" readonly placeholder="Email or Phone" id="username" name="email"
                ...
                <button type="submit" name="submit" id="btn">GO</button>
...
<?php } else {
    ...
    echo "<script>alert('wrong URL');window.location.href = 'index'</script>";
} ?>