...
<style>
    ...
    <div class="page-heading my-1" id="top">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <section class="section" id="products">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading my-2 my-bottom-5">
                        ...
                        <div class="thumb">
                            <div class="hover-content">
                                <ul>
                                    ...
                                    <li><a href="single-product?pid=<?php echo $a->id; ?>"><i class="fa fa-shopping-cart"></i></a></li>
                                </ul>
                            </div  style="height:'300px;'">
                            <img src="assets/images/<?php echo $a->image; ?>" alt="">
                        </div>
