                        ...
                        <li class="nav-item dropdown">
                                ...
                                <div class="navbar-profile">
                                    ...
                                    <p class="mb-0 d-none d-sm-block navbar-profile-name bg-white text-danger "
                                        ...
                                        <?php if(session()->has('adminName')): ?>
                                            <?php echo e(session()->get('adminName')); ?>
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                                ...
                                <?php if(session()->has('adminName')): ?>
                                    ...
                                    <a href="<?php echo e(route('logoutAdmin')); ?>" class="dropdown-item preview-item">
                                        <div class="preview-thumbnail">
                                            <div class="preview-icon bg-dark rounded-circle">
...
</html><?php /**PATH C:\xampp\htdocs\ASSIGNMENT\MODULE – 7(Laravel)\Photo Gallery 2\resources\views/admin/master.blade.php ENDPATH**/ ?>