                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('edit',$s->id)); ?>" class="btn btn-info">EDIT</a>
                                <form action="<?php echo e(route('destroy',$s->id)); ?>" method="post" class="d-inline">
                                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\LARAVEL\RESOURCE-CRUD-APP\resources\views/employees/index.blade.php ENDPATH**/ ?>