	...
	<nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
		...
		<div class="collapse navbar-collapse" id="navbarsDefault">
			...
			<ul class="navbar-nav ml-auto align-items-center">
				...
				<li class="nav-item">
					<a class="nav-link" href="author"><img class="rounded-circle mr-2" src="assets/img/av.png"
...
</html><?php /**PATH C:\xampp\htdocs\ASSIGNMENT\MODULE – 7(Laravel)\Photo Gallery 2\resources\views/author.blade.php ENDPATH**/ ?>